...
@interface SelectPhotosViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UINavigationControllerDelegate, UIImagePickerControllerDelegate,UITableViewDelegate,UITableViewDataSource,PotoTableViewDelegate>
{
...
- (void)createCollectionView{
    ...
    _potoCollectionView = [[UICollectionView alloc]initWithFrame:CGRectMake(0,44, VIEW_WEDTH,VIEW_HEIGHT -44) collectionViewLayout:flowLayout];
...
//    _potoCollectionView.scrollEnabled = YES;
    [_potoCollectionView registerClass:[UICollectionViewCell class] forCellWithReuseIdentifier:cellIdentifier];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    UICollectionViewCell *cell = [_potoCollectionView dequeueReusableCellWithReuseIdentifier:cellIdentifier forIndexPath:indexPath];
    UIImageView *imageView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 0,(VIEW_WEDTH - 16)/3 , (VIEW_WEDTH - 16)/3)];
    if (indexPath.row == 0) {
          imageView.image = [UIImage imageNamed:@"post_album_camera~iphone"];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row==0) {
        [self addCarema];
         ...
         _headImageView.image = _imageArray[(indexPath.row)];
