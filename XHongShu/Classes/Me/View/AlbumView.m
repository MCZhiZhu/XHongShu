...
- (void)createUI:(CGRect)frame{
    ...
    UIImageView *imageView1= [[UIImageView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(_notesLabel.frame)+8,  frame.size.width/2-2, frame.size.width/2-2)];
    imageView1.image = [UIImage imageNamed:@"user"];
    [backView addSubview:imageView1];
    
    UIImageView *imageView2= [[UIImageView alloc]initWithFrame:CGRectMake(frame.size.width/2+2, CGRectGetMaxY(_notesLabel.frame)+8,  frame.size.width/2-2, frame.size.width/2-2)];
    imageView2.image = [UIImage imageNamed:@"user"];
    [backView addSubview:imageView2];
    
    UIImageView *imageView3= [[UIImageView alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(imageView1.frame)+4,  frame.size.width/2-2, frame.size.width/2-2)];
    imageView3.image = [UIImage imageNamed:@"user"];
    [backView addSubview:imageView3];
    
    UIImageView *imageView4= [[UIImageView alloc]initWithFrame:CGRectMake(frame.size.width/2+2, CGRectGetMaxY(imageView1.frame)+4,  frame.size.width/2-2, frame.size.width/2-2)];
